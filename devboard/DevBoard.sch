...
U 1 1 5F605CB8
P 4650 3900
F 0 "J2" H 4700 5017 50  0000 C CNN
F 1 "J3" H 4700 4926 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x20_P2.54mm_Vertical" H 4650 3900 50  0001 C CNN
...
U 1 1 5F60D4C1
P 3850 3900
F 0 "J1" H 3900 5017 50  0000 C CNN
F 1 "J2" H 3900 4926 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x20_P2.54mm_Vertical" H 3850 3900 50  0001 C CNN
...
U 1 1 5F4CF3B4
P 6000 3250
F 0 "U3" H 6000 4231 50  0000 C CNN
F 1 "74HC573" H 6000 4140 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 6000 3250 50  0001 C CNN
F 3 "74xx/74hc573.pdf" H 6000 3250 50  0001 C CNN
	1    6000 3250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F6A6A62
P 6000 6900
F 0 "U5" H 6000 7900 50  0000 C CNN
F 1 "74HC573" H 6000 7800 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 6000 6900 50  0001 C CNN
F 3 "74xx/74hc573.pdf" H 6000 6900 50  0001 C CNN
	1    6000 6900
	1    0    0    -1  
$EndComp
...
GND
Text Label 9500 3250 0    39   ~ 0
GND
Text Label 9500 3300 0    39   ~ 0
3.3V
...
F 1 "74HC573" H 6000 2350 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 6000 1550 50  0001 C CNN
F 3 "74xx/74hc573.pdf" H 6000 1550 50  0001 C CNN
	1    6000 1550
	1    0    0    -1  
$EndComp
Text Label 6000 600  0    50   ~ 0
3.3V
Wire Wire Line
	6000 600  6000 750 
...
GND
Text Label 8700 3250 2    39   ~ 0
3.3V
Text Label 8700 3300 2    39   ~ 0
GND
...
U 1 1 5F54130D
P 6000 5050
F 0 "U4" H 6000 6000 50  0000 C CNN
F 1 "74HC573" H 6000 5950 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 6000 5050 50  0001 C CNN
F 3 "74xx/74hc573.pdf" H 6000 5050 50  0001 C CNN
	1    6000 5050
	1    0    0    -1  
$EndComp
...
A31
Text Label 8700 2950 2    39   ~ 0
A0
Text Label 8700 2900 2    39   ~ 0
A1
Text Label 8700 2850 2    39   ~ 0
A2
Text Label 8700 2800 2    39   ~ 0
A3
Text Label 8700 2750 2    39   ~ 0
A4
Text Label 8700 3800 2    39   ~ 0
A12
Text Label 8700 3750 2    39   ~ 0
A13
Text Label 8700 3700 2    39   ~ 0
A14
Text Label 8700 3650 2    39   ~ 0
A15
Text Label 9500 2750 0    39   ~ 0
A5
Text Label 9500 2800 0    39   ~ 0
A6
Text Label 9500 2850 0    39   ~ 0
A7
Text Label 9500 3600 0    39   ~ 0
A8
Text Label 9500 3650 0    39   ~ 0
A9
Text Label 9500 3700 0    39   ~ 0
A10
Text Label 9500 3750 0    39   ~ 0
A11
Text Label 8700 3600 2    39   ~ 0
A16
...
U 1 1 5F4AD7F4
P 9100 3350
F 0 "U8" H 9100 4175 50  0000 C CNN
F 1 "IS62WV12816ALL" H 9100 4084 50  0000 C CNN
F 2 "Package_SO:TSOP-II-44_10.16x18.41mm_P0.8mm" H 9100 4000 50  0001 C CNN
...
U 1 1 5F71F80C
P 7550 3250
F 0 "U6" H 7550 4231 50  0000 C CNN
F 1 "74HC245" H 7550 4140 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 7550 3250 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74HC245" H 7550 3250 50  0001 C CNN
	1    7550 3250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F722C50
P 7550 5050
F 0 "U7" H 7550 6031 50  0000 C CNN
F 1 "74HC245" H 7550 5940 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm" H 7550 5050 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74HC245" H 7550 5050 50  0001 C CNN
	1    7550 5050
	1    0    0    -1  
$EndComp
...
GND
Text Label 8700 3050 2    39   ~ 0
IO0
Text Label 8700 3100 2    39   ~ 0
IO1
Text Label 8700 3150 2    39   ~ 0
IO2
Text Label 8700 3200 2    39   ~ 0
IO3
Text Label 8700 3350 2    39   ~ 0
IO4
Text Label 8700 3400 2    39   ~ 0
IO5
Text Label 8700 3450 2    39   ~ 0
IO6
Text Label 8700 3500 2    39   ~ 0
IO7
Text Label 9500 3500 0    39   ~ 0
IO8
Text Label 9500 3450 0    39   ~ 0
IO9
Text Label 9500 3400 0    39   ~ 0
IO10
Text Label 9500 3350 0    39   ~ 0
IO11
Text Label 9500 3200 0    39   ~ 0
IO12
Text Label 9500 3150 0    39   ~ 0
IO13
Text Label 9500 3100 0    39   ~ 0
IO14
Text Label 9500 3050 0    39   ~ 0
IO15
...
OE
Text Label 8700 3550 2    39   ~ 0
WE
Text Label 9500 2900 0    39   ~ 0
GND
Text Label 9500 2950 0    39   ~ 0
BHE
Text Label 9500 3000 0    39   ~ 0
A0
Text Label 8700 3000 2    39   ~ 0
A31
$Comp
L DevBoard:S29AL008J70TFI013 U9
U 1 1 5F7419FA
P 9100 4400
F 0 "U9" H 9100 4541 39  0000 C CNN
F 1 "S29AL008J70TFI013" H 9100 4466 39  0000 C CNN
F 2 "Package_SO:TSOP-I-48_18.4x12mm_P0.5mm" H 9100 4450 39  0001 C CNN
F 3 "" H 9100 4450 39  0001 C CNN
	1    9100 4400
	1    0    0    -1  
$EndComp
NoConn ~ 8750 4850
NoConn ~ 8750 4900
Text Label 9450 5600 0    39   ~ 0
A0
Text Label 8750 5600 2    39   ~ 0
A1
Text Label 8750 5550 2    39   ~ 0
A2
Text Label 8750 5500 2    39   ~ 0
A3
Text Label 8750 5450 2    39   ~ 0
A4
Text Label 8750 5400 2    39   ~ 0
A5
Text Label 8750 5350 2    39   ~ 0
A6
Text Label 8750 5300 2    39   ~ 0
A7
Text Label 8750 5250 2    39   ~ 0
A17
Text Label 8750 5200 2    39   ~ 0
A18
Text Label 8750 4800 2    39   ~ 0
A8
Text Label 8750 4750 2    39   ~ 0
A9
Text Label 8750 4700 2    39   ~ 0
A10
Text Label 8750 4650 2    39   ~ 0
A11
Text Label 8750 4600 2    39   ~ 0
A12
Text Label 8750 4550 2    39   ~ 0
A13
Text Label 8750 4500 2    39   ~ 0
A14
Text Label 8750 4450 2    39   ~ 0
A15
Text Label 9450 4450 0    39   ~ 0
A16
Text Label 9450 5400 0    39   ~ 0
IO0
Text Label 9450 5350 0    39   ~ 0
IO8
Text Label 9450 5300 0    39   ~ 0
IO1
Text Label 9450 5250 0    39   ~ 0
IO9
Text Label 9450 5200 0    39   ~ 0
IO2
Text Label 9450 5150 0    39   ~ 0
IO10
Text Label 9450 5100 0    39   ~ 0
IO3
Text Label 9450 5050 0    39   ~ 0
IO11
Text Label 9450 4950 0    39   ~ 0
IO4
Text Label 9450 4900 0    39   ~ 0
IO12
Text Label 9450 4850 0    39   ~ 0
IO5
Text Label 9450 4800 0    39   ~ 0
IO13
Text Label 9450 4750 0    39   ~ 0
IO6
Text Label 9450 4700 0    39   ~ 0
IO14
Text Label 9450 4650 0    39   ~ 0
IO7
Text Label 9450 4600 0    39   ~ 0
IO15
Text Label 9450 4500 0    39   ~ 0
3.3V
Text Label 8750 4950 2    39   ~ 0
WE
NoConn ~ 8750 5150
Text Label 9450 5550 0    39   ~ 0
A30
Text Label 9450 5450 0    39   ~ 0
GND
Text Label 8750 5000 2    39   ~ 0
3.3V
NoConn ~ 8750 5050
Text Label 9450 5000 0    39   ~ 0
3.3V
Text Label 8750 5100 2    39   ~ 0
3.3V
Text Label 9450 5500 0    39   ~ 0
GND
...
U 1 1 5F7598F6
P 4700 5350
F 0 "U1" H 4650 5700 39  0000 L CNN
F 1 "OscillatorSocket" H 4450 5650 39  0000 L CNN
F 2 "Package_DIP:DIP-14_W7.62mm_Socket" H 4700 5350 39  0001 C CNN
F 3 "" H 4700 5350 39  0001 C CNN
	1    4700 5350
	1    0    0    -1  
$EndComp
